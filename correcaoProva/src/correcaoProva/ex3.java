...
public class ex3 {
	...
	public static void main(String[] args) {
		 ...
		 * 23.4, 23.7, 24.0, 24.3, 24.6, 24.9, 25.2, 25.5, 25.8, 26.1, 26.3, 26.5,
		 * 26.7}} Você foi atarefado de desenvolver um programa que realiza uma análise
		 * de dados em uma array bidimensional que representa a informação da
		 * temperatura de uma determinada semana. Cada linha corresponde a um dia da
		 * semana e cada coluna corresponde a uma hora do dia. Calcule: A média diária
		 * de um dia da semana específico. O usuário entrará com o dia da semana por
		 * extenso, por exemplo “domingo”, então você deve pesquisar na linha
		 * correspondente. A média da hora. O usuário entrará com a hora, por exemplo
		 * 15, então você deve pesquisar na coluna correspondente. Qual dia da semana
		 * teve a maior amplitude térmica.
		 * 
		 * 
		 */
